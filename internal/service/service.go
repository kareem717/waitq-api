...
type AccountService interface {
	...
	GetByUserId(ctx context.Context, userId uuid.UUID, requestParams shared.GetManyRequest) (account.Account, error)
}
...
type BillingService interface {
	...
	HandleStripeCheckoutSuccess(ctx context.Context, sessionId string) (billing.AccountSubscription, string, error)
	GetAccountSubscription(ctx context.Context, accountId uuid.UUID) (billing.Subscription, error)
	GetAccountSubscriptionRelationship(ctx context.Context, accountId uuid.UUID) (billing.AccountSubscription, error)
	CancelAccountSubscription(ctx context.Context, accountId uuid.UUID) error
	UpdateAccountSubscription(ctx context.Context, sub *stripe.Subscription) (billing.AccountSubscription, error)
	GetSubscriptionByWaitlistId(ctx context.Context, waitlistId uuid.UUID) (billing.Subscription, error)
	...
	DeleteAccountSubscriptionByCustomerID(ctx context.Context, customerID string) error
}
